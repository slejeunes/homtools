...
# Class definition
########################################################################
class EffectiveTracForm(AFXForm):
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    def __init__(self, owner):
        ...
        # Command
        #
        self.cmd = AFXGuiCommand(self, 'EffectiveTrac', 'HomogeneTraction')
    ...
    def getFirstDialog(self):
        ...
        if(a.getMassProperties()['volume']==None): 
           self.dim.setValue(2)
        db = EffectiveTracDB(self,self.dim)
        return db

    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

class EffectiveTracDB(AFXDataDialog):
    [
        ID_M1,
        ID_M2,
        ID_M3,
    ...
    def __init__(self, form,dim):
        sendCommand("HomogeneTraction.__init__()")
        form.setS1=None

        self.step2=None
        AFXDataDialog.__init__(self, form, 'Homogene tractions on the boundary', self.OK|self.CANCEL)
        ...
        FXMAPFUNC(self,SEL_COMMAND,self.ID_M1,EffectiveTracDB.onCmdM1)
        FXMAPFUNC(self,SEL_COMMAND,self.ID_M2,EffectiveTracDB.onCmdM2)
        FXMAPFUNC(self,SEL_COMMAND,self.ID_M3,EffectiveTracDB.onCmdM3)
        FXMAPFUNC(self,SEL_COMMAND,self.ID_S1,EffectiveTracDB.onCmdS1)
        self.form=form
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class getRP1Procedure(AFXProcedure):
    ...
    def __init__(self,  owner):
        ...
        self.cmd = AFXGuiCommand(self, 'setRefpoint1', 'HomogeneTraction')
...
class getRP2Procedure(AFXProcedure):
    ...
    def __init__(self,  owner):
        ...
        self.owner = owner
        AFXProcedure.__init__(self, owner=owner)
        self.cmd = AFXGuiCommand(self, 'setRefpoint2', 'HomogeneTraction')
...
class getRP3rocedure(AFXProcedure):
    ...
    def __init__(self,  owner):
        AFXProcedure.__init__(self, owner=owner)
        cmd = AFXGuiCommand(self,'setRefpoint3', 'HomogeneTraction')
...
class getS1Procedure(AFXProcedure):
    ...
    def __init__(self,  owner,dim):
        self.dim=dim
        AFXProcedure.__init__(self, owner=owner)
        self.cmd = AFXGuiCommand(self, 'setGroup1', 'HomogeneTraction')
    ...
    def getFirstStep(self):
        if(self.dim==2):
          self.step1=AFXPickStep(self, self.setS1, i18n.tr('Select Edges'), EDGES, MANY,1,TUPLE)
        else:
          self.step1=AFXPickStep(self, self.setS1, i18n.tr('Select Faces'), FACES, MANY,1,TUPLE)
        return self.step1
...
toolset.registerGuiMenuButton(
    object=EffectiveTracForm(toolset), buttonText='Homtools|Stress Uniform Boundary Conditions',
    kernelInitString='import homogeneTraction; HomogeneTraction=homogeneTraction.HomogeneTraction()',
    version='1.0', author='S. Lejeunes & S. Bourgeois (LMA-CNRS UPR7051)',
    applicableModules = ['Interaction'],
    description='A simple Gui to define homogene Boundary Conditions for Effective Modulus Homogeneization'
